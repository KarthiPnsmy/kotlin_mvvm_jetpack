...
interface ToolDao {
    ...
    suspend fun insertToolWithFriend(toolFriendCrossRef: ToolFriendCrossRef)
    ...
    @Query(
        "SELECT Friend.name as friendName, ToolFriendCrossRef.toolId, Tool.name as toolName, Tool.image as toolImage, COUNT(ToolFriendCrossRef.toolId) as quantity\n" +
